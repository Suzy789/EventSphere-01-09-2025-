<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ViewVolunteers.aspx.cs" Inherits="Authentication.User.ViewVolunteer" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <!-- Banner -->
   <div class="banner mb-4">
       <h1 class="mb-1">Volunteers for Event</h1>
       <p class="text-muted">Below is the list of applicants who have applied to volunteer for this event.</p>
   </div>
        ...
        <asp:Repeater ID="rptCategories" runat="server" OnItemDataBound="rptCategories_ItemDataBound">
            <ItemTemplate>
                ...
                <h5 class="sub-heading mt-4">
                    <%# Eval("CategoryName") %> 
                    <small class="text-muted">(Required: <%# Eval("RequiredVolunteers") %>, Allocated: <%# Eval("AllocatedVolunteers") %>)</small>
                </h5>
